# Resource Test PlantUML/GraphViz compatibility
...
```json
{
  ...
  "id" : "test.plantuml.bug",
  "language" : "fr",
  "url" : "https://example.com/ig/test-plantuml-bug/ImplementationGuide/test.plantuml.bug",
  "version" : "0.1.0",
  "name" : "TestPlantUMLBug",
  "title" : "Test PlantUML/GraphViz compatibility",
  "status" : "draft",
  "date" : "2026-06-16T16:17:42+00:00",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://example.com/ig/test-plantuml-bug/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "resource" : [{
      ...
      "reference" : {
        "reference" : "StructureDefinition/TestUsager"
      },
      "name" : "Usager test",
